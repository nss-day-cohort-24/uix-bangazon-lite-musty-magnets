...
let ProductThumbnail = (props) => {
    return(
        <div className="card mt-4 mr-2 ml-2 product-card" >
                    ...
                    <h2 className="card-title">{/*{props.name}*/} Product name</h2>

                    <div className="card-body">
                        <div className="row">
                            <p className="card-text col text-left">{/*{props.price}*/}$15.00 </p>
                            <p className="card-text col text-right prod-qty">QTY {/*{props.quantity}*/} 1</p>
                        </div>         
                    </div>
        </div>
    )
